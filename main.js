...
links[4].onclick=function() {
	...
	h1.innerHTML='Events'
	p = detail.querySelector('p')
	p.innerHTML="<div class='list'><h3>Upcoming</h3></div><div class='item'><em>5/13/2024</em><a target ='_blank' href='http://parsons.nyc/keynotes'>Parsons School of Design Data Visualization Keynotes 6-8pm. Wollman Hall, New York</a></div>"
